...
import wanpracha.rmutsv.ac.th.rmutsvmytimes.utility.GetAllData;

/**
 * Created by bow on 26/1/2561.
 */
...
//        Create GraphView
        try {
            String strURL = "http://androidthai.in.th/piw/getAllFirebaseBrownie.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout
                .fragment_graph, container, false);
